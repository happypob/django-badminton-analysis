...
Page({
  ...
  sendData1() {
    wx.request({
      url: 'http://192.168.125.130:8000/wxapp/send_data1/',  // 修正端口号
      method: 'POST',
      data: {
        type: 1,
        content: '这是数据1'
  ...
  sendData2() {
    wx.request({
      url: 'http://192.168.125.130:8000/wxapp/send_data2/',  // 修正端口号
      method: 'POST',
      data: {
        type: 2,
        content: '这是数据2'
  ...
  sendData3() {
    wx.request({
      url: 'http://192.168.125.130:8000/wxapp/send_data3/',  // 修正端口号
      method: 'POST',
      data: {
        type: 3,
        content: '这是数据3'
